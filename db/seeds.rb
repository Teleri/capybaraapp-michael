...
user.save
Interest.create(name: Category.first.name, user_id: User.first.id, category_id: Category.first.id)
Interest.create(name: Category.find(9).name, user_id: User.first.id, category_id: Category.find(9).id)
Interest.create(name: Category.second.name, user_id: User.first.id, category_id: Category.second.id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.second.id, category_id: Category.first.id)
Interest.create(name: Category.find(7).name, user_id: User.second.id, category_id: Category.find(7).id)
Interest.create(name: Category.find(9).name, user_id: User.second.id, category_id: Category.find(9).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.third.id, category_id: Category.first.id)
Interest.create(name: Category.second.name, user_id: User.third.id, category_id: Category.second.id)
Interest.create(name: Category.find(7).name, user_id: User.third.id, category_id: Category.find(7).id)
...
Interest.create(name: Category.first.name, user_id: User.find(4).id, category_id: Category.first.id)
Interest.create(name: Category.find(9).name, user_id: User.find(4).id, category_id: Category.find(9).id)
Interest.create(name: Category.find(4).name, user_id: User.find(4).id, category_id: Category.find(4).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.find(5).id, category_id: Category.first.id)
Interest.create(name: Category.find(9).name, user_id: User.find(5).id, category_id: Category.find(9).id)
Interest.create(name: Category.find(4).name, user_id: User.find(5).id, category_id: Category.find(4).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.find(6).id, category_id: Category.first.id)
Interest.create(name: Category.find(2).name, user_id: User.find(6).id, category_id: Category.find(2).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.find(7).id, category_id: Category.first.id)
Interest.create(name: Category.find(4).name, user_id: User.find(7).id, category_id: Category.find(4).id)
Interest.create(name: Category.find(9).name, user_id: User.find(7).id, category_id: Category.find(9).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.find(8).id, category_id: Category.first.id)
Interest.create(name: Category.find(4).name, user_id: User.find(8).id, category_id: Category.find(4).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.find(9).id, category_id: Category.first.id)
Interest.create(name: Category.find(4).name, user_id: User.find(9).id, category_id: Category.find(4).id)
...
user.photo.attach(io: file, filename: "mia.jpg", content_type: "image/jpg")
user.save
Interest.create(name: Category.first.name, user_id: User.find(10).id, category_id: Category.first.id)
Interest.create(name: Category.find(4).name, user_id: User.find(10).id, category_id: Category.find(4).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.find(11).id, category_id: Category.first.id)
Interest.create(name: Category.find(3).name, user_id: User.find(11).id, category_id: Category.find(3).id)
Interest.create(name: Category.find(4).name, user_id: User.find(11).id, category_id: Category.find(4).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.find(12).id, category_id: Category.first.id)
Interest.create(name: Category.find(9).name, user_id: User.find(12).id, category_id: Category.find(9).id)
Interest.create(name: Category.find(4).name, user_id: User.find(12).id, category_id: Category.find(4).id)
...
user.save
Interest.create(name: Category.find(8).name, user_id: User.find(13).id, category_id: Category.find(8).id)
Interest.create(name: Category.find(10).name, user_id: User.find(13).id, category_id: Category.find(10).id)
...
user.save
Interest.create(name: Category.find(4).name, user_id: User.find(14).id, category_id: Category.find(4).id)
Interest.create(name: Category.first.name, user_id: User.find(14).id, category_id: Category.first.id)
Interest.create(name: Category.find(3).name, user_id: User.find(14).id, category_id: Category.find(3).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.find(15).id, category_id: Category.first.id)
Interest.create(name: Category.find(4).name, user_id: User.find(15).id, category_id: Category.find(4).id)
Interest.create(name: Category.find(3).name, user_id: User.find(15).id, category_id: Category.find(3).id)
...
user.save
Interest.create(name: Category.first.name, user_id: User.last.id, category_id: Category.first.id)
Interest.create(name: Category.find(3).name, user_id: User.last.id, category_id: Category.find(3).id)
Interest.create(name: Category.find(5).name, user_id: User.last.id, category_id: Category.find(5).id)
Interest.create(name: Category.find(6).name, user_id: User.last.id, category_id: Category.find(6).id)
